...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col px-4 md:px-10 py-6 min-h-screen gap-8 shadow-sm">
      ...
      {/* Main Content */}
      <div className="flex flex-col md:flex-row justify-center items-start gap-6 rounded-[10px] bg-neutral-100 shadow-md    p-9">
        {/* Bar Graph */}
      ...
      <div className="mt-6 rounded-[10px] p-5 bg-neutral-100 shadow-md">
